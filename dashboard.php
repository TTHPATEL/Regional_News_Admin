...
<html>
<head>
<title>KutchToday | Home </title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="KutchToday" />
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $exrow['Totalexpense'] ;?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $incomerow['Totalincome'] ;?></strong></h5>

                      <span>Total Advertisement Income</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo $comprow['Totalcomp'] ;?></strong></h5>
		...
		<div class="charts">		
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">e-Newspaper Slider</h4>
					<!-- start content_slider -->
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/Newspaper_Photo.png" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="images/Newspaper_Photo.png" alt="name">
						</div>
